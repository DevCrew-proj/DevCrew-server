...
@AllArgsConstructor
public class DesignComment extends BaseTimeEntity {
    @Id
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "designfeedback_id", nullable = false)
    ...
    public void setFeedbacktoComment(DesignFeedback designFeedback) {
