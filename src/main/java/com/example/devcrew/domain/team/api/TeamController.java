...
public class TeamController {
    ...
    @GetMapping("/create")
    @Operation(summary = "팀 구성 기능에서 멤버 정보 조회", description = "팀 생성 시 해당 멤버의 이름 반환(자동완성기능), name이 null이면 null 반환.")
    ...
    @GetMapping("/apply")
    @Operation(summary = "팀 신청 기능에서 멤버 정보 조회", description = "팀원 신청서 작성 시 해당 멤버의 이름 반환(자동완성기능), name이 null이면 null 반환")
