...
public class S3Controller {
    ...
    public CreateProfileImageResponse generatePresignedUrl(@RequestParam String fileName, @RequestParam String fileExtension){
        return s3Service.generatePresignedUrl("member",fileName,fileExtension);
